...
var minIncrementForUnique = function (nums) {
  ...
  // Now store first element in set
  // Now start traversing from index = 1 till end
  // if any index is there in set, do count++ and +1 in it and again check set
  // if its there, again do the same
  // if its not there means its a unique one, store it
  // Do this till end of the array
  let n = nums.length;
  let st = new Set();
  st.add(nums[0]);
  let count = 0;
